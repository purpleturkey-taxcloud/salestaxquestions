...
tldr: "Doubling GMV typically adds 6–10 new nexus states per year as states cross the $100K threshold, upgrades filing frequencies in existing states from annual to quarterly or monthly, and expands physical nexus as new 3PL relationships and FBA placements come online. The compliance setup that worked at $5M fails silently at $10M — monitor trailing 12-month sales by state monthly and expect 5–10 frequency reassignment notices per year at scale."
faqs:
