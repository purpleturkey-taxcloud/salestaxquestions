...
> **TaxCloud automatically monitors FBA inventory states through Amazon integration** and alerts you when new FBA nexus appears, so you can register before liability accumulates. [See how it works →](#)
...
- [How do I handle nexus created by a 3PL I just started using?](#)
