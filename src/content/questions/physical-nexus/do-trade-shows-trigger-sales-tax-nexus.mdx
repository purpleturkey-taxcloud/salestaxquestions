...
> **TaxCloud handles registration in states where trade show or event activity has created nexus**: including retroactive registration and coordination with the VDA process where applicable. [See how it works →](#)
