...
tldr: "Your supplier's warehouse doesn't create nexus for you — your nexus comes from your own inventory, employees, and economic threshold crossings. The real compliance challenge in drop shipping is exemption certificates: when your supplier has nexus in the ship-to state and you don't, they may need to collect tax unless you can provide a valid resale certificate for that state."
faqs:
