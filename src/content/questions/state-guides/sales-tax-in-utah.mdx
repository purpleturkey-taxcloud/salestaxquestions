...
tldr: "Utah is an SST member state with a 4.85% state rate and multi-layer local additions — county, city, and transit districts — pushing Salt Lake County to 7.25% and some areas above 9%. Food and food ingredients are taxed at a reduced 3% state rate, not exempt. The threshold is $100,000 or 200 transactions."
faqs:
