...
tldr: "Mississippi's economic nexus threshold is $250,000 — higher than the standard $100,000 — and it enacted economic nexus rules in December 2017, before the Wayfair decision. The 7% state rate is one of the highest base rates in the country; counties don't add to it, keeping the rate structure simple. Mississippi is not an SST member."
faqs:
