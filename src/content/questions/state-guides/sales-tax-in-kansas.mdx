...
tldr: "Kansas is an SST member state with a 6.5% state rate and local additions reaching 10%+. As of January 1, 2025, Kansas fully eliminated its state sales tax on food and food ingredients — phased down from 6.5% over two years. Local taxes may still apply to groceries, but the state portion is now zero."
faqs:
