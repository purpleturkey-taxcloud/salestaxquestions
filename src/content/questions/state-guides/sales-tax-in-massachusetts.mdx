...
tldr: "Massachusetts has a flat 6.25% statewide rate with no local additions and a $100,000 threshold (no transaction count). Clothing items under $175 per piece are exempt; items above $175 are taxed only on the amount exceeding $175. Separately stated shipping is not taxable."
faqs:
