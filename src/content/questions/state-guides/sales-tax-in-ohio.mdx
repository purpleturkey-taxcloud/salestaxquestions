...
tldr: "Ohio is an SST member state with a 5.75% state rate and county additions across all 88 counties, for combined rates of 6.5%–8%. There are no city-level sales taxes — county is the only local layer. Cuyahoga County (Cleveland) has the state's highest combined rate at 8%."
faqs:
