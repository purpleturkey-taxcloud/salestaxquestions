...
tldr: "North Carolina is an SST member state with a 4.75% state rate and county additions across all 100 counties, for combined rates of 6.75%–7.5%. There are no city-level additions — county is the only local layer. North Carolina taxes digital products and SaaS, which is notable for technology sellers."
faqs:
