...
tldr: "Tennessee is an SST member state with a 7% state rate and local additions reaching 9.75% in some counties — among the highest combined rates in the country. The threshold is $100,000 with no transaction count. Food and food ingredients are taxed at a reduced 4% state rate rather than being exempt."
faqs:
