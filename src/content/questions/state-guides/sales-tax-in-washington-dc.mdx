...
tldr: "Washington DC has a 6% general sales tax rate with no local complexity — DC is a single jurisdiction. Elevated rates apply to restaurant meals (10%) and alcohol (10.25%). DC taxes digital goods and streaming services. The threshold is $100,000 or 200 transactions; DC is not an SST member."
faqs:
