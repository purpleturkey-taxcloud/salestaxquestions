...
tldr: "California's economic nexus threshold is $500,000 — the highest in the country — with a 7.25% state rate and local district taxes pushing combined rates up to 10.75%. California is not an SST member; sellers register with the CDTFA, and the third-party access PIN is mailed, adding 1–3 weeks to account setup."
faqs:
