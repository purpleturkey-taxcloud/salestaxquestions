...
tldr: "Since July 2021, the EU's €22 de minimis exemption is gone — all imports are subject to VAT. For orders under €150, you collect VAT at checkout using a single IOSS registration in one EU country and file one monthly return. For orders above €150, customs collects VAT from the buyer at the border."
faqs:
