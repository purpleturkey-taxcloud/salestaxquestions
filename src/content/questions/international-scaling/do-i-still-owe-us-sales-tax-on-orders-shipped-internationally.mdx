...
tldr: "No. US sales tax does not apply to orders shipped outside the US — taxability follows the ship-to address, and international addresses fall outside every US state's jurisdiction. If an international buyer ships to a US address, normal US sales tax rules apply based on that destination state."
faqs:
