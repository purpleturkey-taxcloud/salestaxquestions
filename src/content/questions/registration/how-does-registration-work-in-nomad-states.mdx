...
tldr: "No registration needed in Montana, Oregon, New Hampshire, or Delaware — no sales tax exists, so there's nothing to collect or file. Alaska has no state tax but local jurisdictions do; remote sellers above $100,000 in Alaska sales may need to register with the Alaska Remote Seller Sales Tax Commission."
faqs:
