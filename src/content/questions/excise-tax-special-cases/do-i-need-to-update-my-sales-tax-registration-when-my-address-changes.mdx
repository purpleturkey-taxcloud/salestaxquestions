...
tldr: "Yes — update your address with every state you're registered in, separately, through each state's DOR portal. Audit notices, proposed assessments, and (in California) PIN letters all go to the address on file. A stale address means missed notices and waived appeal rights."
faqs:
