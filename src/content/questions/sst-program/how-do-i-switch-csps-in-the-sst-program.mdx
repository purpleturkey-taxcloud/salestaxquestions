...
> **Switching to TaxCloud?** TaxCloud is a Certified Service Provider and handles the CSP Transfer as part of onboarding, initiating the request, tracking the effective date, and confirming the filing handoff so there's no gap. [Start the transfer →](#)
