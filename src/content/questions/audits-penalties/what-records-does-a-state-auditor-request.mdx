...
tldr: "Auditors request transaction-level sales data, all filed returns, exemption certificates for every exempt sale, purchase records for use tax verification, and general ledger entries. Missing exemption certificates are the most common finding — they automatically convert exempt sales to taxable. Auditors increasingly request direct access to QuickBooks or NetSuite rather than printed reports."
faqs:
