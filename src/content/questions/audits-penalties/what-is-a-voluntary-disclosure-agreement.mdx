...
tldr: "A VDA lets you proactively settle historical sales tax exposure on defined terms: a 3–4 year lookback limit, full penalty waiver, and no audit for covered periods. The process is anonymous until you accept the state's terms. A VDA is no longer available once a state initiates contact — it must be voluntary and unprompted."
faqs:
