...
tldr: "Rank states by estimated dollar liability: sales volume × tax rate × years non-filing. For most ecommerce sellers, CA, TX, NY, FL, and WA come first. Use the MTC multi-state VDA program to address multiple high-priority states simultaneously rather than managing separate negotiations."
faqs:
