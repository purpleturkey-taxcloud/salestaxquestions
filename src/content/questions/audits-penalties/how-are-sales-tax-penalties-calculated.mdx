...
tldr: "Penalties are calculated as a percentage of unpaid tax: 5–10% for late filing or payment, 10–25% for failure to file or register. Interest accrues separately at 3–12% annually, compounding from each period's original due date. In a multi-year audit, interest alone can rival the penalty amount."
faqs:
