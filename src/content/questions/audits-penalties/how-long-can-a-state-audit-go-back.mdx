...
tldr: "For filed returns, the audit window is typically 3–4 years from the filing date. For unfiled periods, there is no time limit — states can reach back to whenever nexus first existed. A VDA caps this exposure at a negotiated 3–4 year lookback, regardless of how long the seller was actually non-compliant."
faqs:
