...
tldr: "Start collecting immediately in every state where you have nexus. Then address the past: a VDA is the right path for significant multi-year exposure, offering a 3–4 year lookback cap and penalty waiver. Doing nothing is not a real option — states use 1099-K data and marketplace reporting to find non-compliant sellers systematically."
faqs:
