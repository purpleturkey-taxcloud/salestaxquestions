...
tldr: "Some states, including TX and CA, offer first-time penalty abatement for taxpayers with a clean compliance history, but it requires paying the full tax first and approval is not guaranteed. For years of unregistered nexus, a VDA is the more reliable path — it provides a written, negotiated agreement rather than a discretionary abatement that can be denied."
faqs:
