...
tldr: "Most states require 3–5 years, but 7 years is the practical safe standard — it covers audit lookback periods in virtually every state. For exemption certificates, the retention clock runs from the last exempt transaction with each customer, not the certificate date, so keep them for the life of the relationship plus 7 years."
faqs:
