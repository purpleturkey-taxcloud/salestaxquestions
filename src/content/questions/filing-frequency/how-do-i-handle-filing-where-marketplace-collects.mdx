...
tldr: "Having a registered permit means you still need to file a return, even when Amazon collected all the tax for you. Report your gross sales, then deduct the marketplace-facilitated amount — the return shows $0 owed but must still be submitted. Skipping it generates a late filing penalty."
faqs:
