...
tldr: "A prepayment is a mid-period estimated tax payment required before the regular return is due. California requires it for sellers with monthly liability above $17,000, due by the 24th of the current month. New York has similar requirements for large quarterly filers. Most sellers are below the threshold and never encounter it."
faqs:
