...
tldr: "Missing a deadline triggers late filing penalties (typically 5–25% of tax due), late payment penalties, and interest at 8–12% annualized from the original due date. File immediately — every day of delay adds interest. Most states will abate first-offense penalties if you file, pay the tax and interest, and submit a written abatement request."
faqs:
