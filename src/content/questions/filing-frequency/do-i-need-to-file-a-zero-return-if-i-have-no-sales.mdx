...
tldr: "Yes, in most states. An active permit means you must file every period, even with zero sales and zero tax due. Missing a zero return triggers the same late penalties as a return with a balance owed. Texas is the most notable exception."
---
