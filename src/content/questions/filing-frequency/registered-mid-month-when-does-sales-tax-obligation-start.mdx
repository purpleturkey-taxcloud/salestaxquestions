...
> **Starting fresh with TaxCloud?** We configure your permit effective date in every state during onboarding and handle the first partial-period filings so nothing slips through. [See how onboarding works →](#)
