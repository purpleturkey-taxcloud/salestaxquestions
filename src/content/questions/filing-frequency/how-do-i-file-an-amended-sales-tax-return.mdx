...
tldr: "Log into the state portal, locate the original return, and submit a corrected version. If you owe additional tax, pay it with the amendment — interest accrues from the original due date, not the amendment date. Amendments are generally limited to 3–4 years back; overpayments generate credits or refunds."
faqs:
