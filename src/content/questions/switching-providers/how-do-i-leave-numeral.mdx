...
> **If you're evaluating alternatives:** Numeral charges $75/return per state, every period. Platforms with SST CSP enrollment cover qualifying sellers in 24 SST states at no per-return charge: the state funds the filing through the CSP program. For sellers with significant SST state footprints, the cost math changes significantly. [taxcloud.com](#)
