...
tldr: "Your SST registration is held with the SST Governing Board, not your current CSP — switching providers transfers the authorized agent on your account, not your registration itself. Your new CSP submits the transfer request; your current CSP typically has 30 days to respond, and the process takes 2–4 weeks. Do not cancel your current CSP before the transfer is confirmed or your SST states will have no authorized filer when returns come due."
---
