...
> **If you're switching to a CSP platform:** TaxJar doesn't participate in the Streamlined Sales Tax program, which means every filing in every state costs you $50–55 regardless. A CSP platform like TaxCloud enrolls qualifying sellers in SST, filing in 24 SST states is covered by the program, not charged per return. Worth understanding the math on your specific state footprint before choosing your next provider. [taxcloud.com](#)
