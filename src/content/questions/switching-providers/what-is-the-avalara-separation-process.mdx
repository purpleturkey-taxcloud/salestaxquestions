...
> **If you're switching to another CSP:** TaxCloud is a Certified Service Provider in the SST program and handles the CSP transfer as part of onboarding, they'll take your SST ID and request access from their side. For sellers who weren't fully enrolled in SST under Avalara, the cost difference on SST-state filings can be significant. Worth a direct comparison before you commit to the next provider. [taxcloud.com](#)
