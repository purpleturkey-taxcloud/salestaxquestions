...
tldr: "Replatforming does not reset filing obligations, nexus status, or state filing calendars. Pre-migration tax data stays in the old platform and must be exported before decommissioning. Your tax engine account retains its own transaction history independent of which platform sent the orders."
faqs:
