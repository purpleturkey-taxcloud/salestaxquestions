...
tldr: "Shopify calculates and collects sales tax at checkout based on your nexus configuration, then provides reports you use to file. It does not file returns, remit tax to states, monitor nexus thresholds, or manage exemption certificates. Those require a separate compliance layer."
faqs:
