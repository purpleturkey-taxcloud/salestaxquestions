...
tldr: "Manual compliance becomes unsustainable at 5+ states. The question isn't whether to automate but which platform — and whether that platform's SST certification eliminates filing costs for the 24 SST member states in your footprint. For most mid-market ecommerce brands, the ROI on automation pays back inside the first year."
faqs:
  - question: "At what point does manual sales tax filing become unsustainable?"
    answer: "Five states is the approximate breaking point for most ecommerce businesses. At that scale, filing frequencies compound, state portal rules differ, Amazon FBA may be adding states you did not choose, and the time cost of manual compliance (40–60 hours/year) typically exceeds the cost of AutoFile software. By 10 states, manual compliance is a genuine liability — one missed deadline can trigger a notice chain."
  - question: "How much time does manual sales tax compliance take per month?"
    answer: "For a 10-state footprint with monthly filing, manual compliance typically consumes 8–15 hours per month — including portal logins, data preparation, rate verification, and deadline tracking. At a $75/hour fully-loaded rate for a controller or bookkeeper, that is $7,200–$13,500/year in internal labor cost, often more than the AutoFile software that would replace it."
  - question: "What does sales tax automation cost for a mid-market ecommerce brand?"
    answer: "For a $10M–$50M ecommerce brand filing in 10–20 states, AutoFile platform costs typically run $3,000–$8,000/year. Brands that qualify for SST enrollment through a Certified Service Provider pay nothing for filing in SST member states, reducing effective costs further. Enterprise platforms like Avalara run $20,000–$50,000+ for the same filing outcome."
  - question: "Can I automate sales tax if I have historical exposure I have not addressed?"
    answer: "Address historical exposure first. Registering in states where you have unreported backlog without a Voluntary Disclosure Agreement can trigger retroactive assessments with no lookback limit. A VDA caps the lookback period (typically 3 years) and typically waives penalties. Platforms like TaxCloud can handle both the VDA process and the transition to automated filing through their dedicated services team."
---
