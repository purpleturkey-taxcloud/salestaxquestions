...
faqs:
  - question: "Is Kintsugi cheaper than Avalara?"
    answer: "At low state counts (under 8 states), yes. Kintsugi's Starter plan at $75/filing is significantly cheaper than Avalara's $7,400–$18,000+ annual contracts. Above 8–10 states filing monthly, Kintsugi's per-return costs approach Avalara's range. Kintsugi is not an SST Certified Service Provider, so there is no cost relief for SST member states on either platform."
  - question: "Is Kintsugi an SST Certified Service Provider?"
    answer: "No. As of May 2026, Kintsugi is not listed on the Streamlined Sales Tax Governing Board's published Certified Service Provider roster. Kintsugi charges $75 per filing in every state, including SST member states where a CSP-enrolled seller would pay nothing."
  - question: "Does Kintsugi handle SaaS and digital goods taxation?"
    answer: "Yes. Kintsugi was purpose-built for SaaS and digital goods companies, with specific handling for subscription billing models, per-seat pricing, and the patchwork of state-level SaaS taxability rules. This is a genuine advantage over platforms designed primarily for physical goods sellers."
  - question: "Is Avalara right for a SaaS company under $30M revenue?"
    answer: "Typically not. Avalara is enterprise infrastructure priced for large organizations. The implementation complexity, annual contract requirements, and $7,400–$18,000+ pricing structure are designed for companies with dedicated tax teams. Most SaaS companies under $30M are better served by a purpose-built platform like Kintsugi (for digital goods focus) or TaxCloud (for SST-state cost savings on physical goods)."
---
