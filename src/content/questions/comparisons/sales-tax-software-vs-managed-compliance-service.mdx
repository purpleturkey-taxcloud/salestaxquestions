...
|---|---|---|---|---|---|
| **Pricing transparency** | Published | Published | Requires quote | Not published | Published |
...
| **Amazon / marketplace integration** | Yes | Yes | Yes | Limited | Limited |
| **Canada filing** | Yes | No | Yes | No | No |
| **US-based human support** | Yes | No (post-acquisition) | No (outsourced) | Not consistently | Not US-based |
| **Virtual mailbox / notice management** | Yes | No | Ticket-based | No | No |
| **Dedicated onboarding manager** | Yes | No | Enterprise only | Self-directed | Self-directed |
| **VDA / backfiling services** | Yes — handled in-house | No | Third-party referral | No | No |
