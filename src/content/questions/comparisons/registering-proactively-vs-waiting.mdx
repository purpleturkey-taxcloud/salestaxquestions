...
tldr: "Register proactively. Waiting increases penalty exposure with every filing period, and VDAs — which can address historical exposure — become less favorable the longer you delay. The cost of registration is trivial compared to the cost of a multi-year audit discovery."
faqs:
  - question: "Should I register for sales tax before I hit nexus?"
    answer: "Register proactively if nexus is clearly coming — you are at 70%+ of a state's economic threshold, FBA inventory is moving into a new state, or you are hiring remotely there. Do not register speculatively in states with no near-term nexus path, as it creates filing obligations including zero returns. The key risk of waiting: most sellers catch nexus events late, after uncollected tax has already accumulated across multiple periods."
  - question: "What happens if I miss the moment I cross an economic nexus threshold?"
    answer: "Every sale after you crossed the threshold but before you registered is technically uncollected tax. If the backlog is material (more than a few months or a few thousand dollars), a Voluntary Disclosure Agreement is the right path — it caps the lookback period (typically 3 years) and typically waives penalties. Registering directly without a VDA in this situation can trigger a retroactive audit with no lookback limit."
  - question: "Does Amazon FBA create nexus in states I have not chosen to sell in?"
    answer: "Yes. Amazon moves inventory between fulfillment centers without seller notification. The moment your inventory arrives in a state, you have physical nexus there regardless of your sales volume. Sellers who wait to check the Inventory Ledger often discover they have had nexus in multiple states for months or years without registering — and without collecting tax."
  - question: "Is registering in SST states different from registering in non-SST states?"
    answer: "Yes, significantly easier. SST member states offer centralized registration through the SST Central Registration system — one application covers all 24 member states simultaneously. Non-SST states each require their own individual registration process. For sellers using a CSP platform like TaxCloud, SST registration is handled during onboarding and the ongoing filing burden in those states carries no additional charge."
---
...
> **See:** [VDA vs. registering retroactively without a VDA: which is safer?](/vda-vs-registering-retroactively) if you've already discovered a compliance gap.
