...
tldr: "SST member states are structurally cheaper for qualifying sellers: registration, calculation, and filing are covered through a Certified Service Provider at no charge to the seller. Brands with significant SST-state nexus should choose a CSP platform to capture this benefit — non-CSP platforms charge full rate regardless of which states you're filing in."
faqs:
  - question: "Which states are SST member states?"
    answer: "As of 2026, the 24 SST member states are: Arkansas, Georgia, Indiana, Iowa, Kansas, Kentucky, Michigan, Minnesota, Nebraska, Nevada, New Jersey, North Carolina, North Dakota, Ohio, Oklahoma, Rhode Island, South Dakota, Tennessee, Utah, Vermont, Washington, West Virginia, Wisconsin, and Wyoming. California, Texas, Florida, and New York are not SST members."
  - question: "Is filing in SST member states free?"
    answer: "For qualifying remote sellers enrolled through a Certified Service Provider, yes. Registration, calculation, filing, and remittance in all 24 SST member states are covered through the CSP program at no charge to the seller — the state compensates the CSP directly. Only sellers with no physical presence (employees, inventory, offices) outside their home state typically qualify as remote sellers."
  - question: "What is a Certified Service Provider (CSP) in the SST program?"
    answer: "A Certified Service Provider is a sales tax platform that holds a formal designation from the Streamlined Sales Tax Governing Board to serve SST-enrolled sellers. The CSP receives compensation directly from SST member states, so qualifying sellers pay nothing for filing in those states. As of May 2026, TaxCloud, Avalara, Sovos, Avior, and AccurateTax are listed CSPs. TaxJar, Numeral, and Kintsugi are not."
  - question: "Why do some platforms not pass SST savings to sellers?"
    answer: "Avalara holds CSP status but charges per-state filing fees for SST states rather than passing the state-funded coverage to customers — capturing the CSP compensation as platform revenue. TaxJar is not a CSP at all. TaxCloud proactively enrolls qualifying sellers and passes the full SST benefit through, so SST states carry no additional filing charge beyond the base platform fee."
---
...
> **See:** [Why won't Avalara and TaxJar tell me about SST benefits?](/why-wont-avalara-taxjar-tell-me-about-sst-benefits) for the full explanation of why this happens.
