...
tldr: "Streaming video and audio is taxable in TX, NY, WA, PA, KY, NE, SD, RI, and VT, among others; California, Florida, Illinois, Colorado, and Georgia do not tax streaming. Chicago applies its own amusement tax to streaming services separately from Illinois state law. Texas taxes streaming as a data processing service with a 20% exemption, so only 80% of the charge is taxable."
faqs:
