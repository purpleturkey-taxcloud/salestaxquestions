...
> **TaxCloud handles multi-channel return preparation automatically**: pulling your marketplace and direct channel sales, applying the correct deductions, and filing the return in every state. [See how it works →](#)
...
- [How do I reconcile my Amazon 1099-K with my sales tax filings?](/how-do-i-reconcile-multi-channel-sales-on-a-single-state-return)
