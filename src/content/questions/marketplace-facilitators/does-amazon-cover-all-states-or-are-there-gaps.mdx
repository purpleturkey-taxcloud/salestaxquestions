...
tldr: "Amazon collects and remits sales tax in all 45 states with a sales tax plus DC — its rollout to all states was completed in 2021–2022. Coverage applies only to Amazon transactions; your own website, Shopify store, and other channels remain entirely your responsibility. Alaska local taxes and direct B2B sales outside Amazon are the only meaningful edge cases."
faqs:
