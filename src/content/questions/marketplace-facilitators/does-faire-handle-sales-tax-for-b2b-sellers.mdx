...
tldr: "Faire operates as a marketplace facilitator but most Faire sales are exempt — buyers are retailers with resale certificates, and Faire collects those certificates and applies exemptions at checkout. The real compliance question for Faire sellers is nexus, not collection: high wholesale volume into a state can still trigger economic nexus registration requirements."
faqs:
